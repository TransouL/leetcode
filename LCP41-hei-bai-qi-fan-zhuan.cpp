...
int main(void) {
	...
	cout << solution.flipChess(vector<string>{"....X.", "....X.", "XOOO..", "......", "......"}) << endl;
	cout << solution.flipChess(vector<string>{".X.", ".O.", "XO."}) << endl;
	cout << solution.flipChess(vector<string>{".......", ".......", ".......", "X......", ".O.....", "..O....", "....OOX"}) << endl;
}